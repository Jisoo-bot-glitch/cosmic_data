...
def main() -> None:
    ...
    mission = SpaceMission(
        ...
        destination="Mars",
        launch_date=datetime(2024, 1, 15, 10, 30, 30),
        duration_days=900,
    ...
    print("Crew members:")
    print(f"{member1.name} ({member1.rank.value}) - {member1.specialization}")
    print(f"{member2.name} ({member2.rank.value}) - {member2.specialization}")
    print(f"{member3.name} ({member3.rank.value}) - {member3.specialization}")
    print()
    print("========================================")
